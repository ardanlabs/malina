...
func TestLatestSDVersionSelectsGreatestBuild(t *testing.T) {
	releases := []sdRelease{
		{TagName: "master-840-0a565f2"},
		{TagName: "master-841-6b3edaa"},
	...
	matchTests := []struct {
	...
	}{
		{
			...
			matches: []string{
				...
				"sd-master-6b3edaa-bin-Darwin-macOS-26.5.2-arm64.zip",
			},
			rejects: []string{
		...
		},
		{
			...
			matches: []string{"sd-master-6b3edaa-bin-Darwin-macOS-26.5.2-arm64.zip"},
		},
		{
			...
			matches: []string{
				...
				"sd-master-6b3edaa-bin-win-cpu-x64.zip",
			},
			rejects: []string{
		...
		},
		{
			...
			matches: []string{"sd-master-6b3edaa-bin-Linux-Ubuntu-24.04-x86_64.zip"},
			rejects: []string{
		...
		},
		{
			...
			matches: []string{"sd-master-6b3edaa-bin-Linux-Ubuntu-24.04-x86_64-vulkan.zip"},
		...
		},
		{
			...
			matches: []string{
				"sd-master-6b3edaa-bin-Linux-Ubuntu-24.04-x86_64-rocm-7.14.0.zip",
				"sd-master-656-0e4ee04-bin-Linux-Ubuntu-24.04-x86_64-rocm-7.2.1.zip",
			},
		},
	}
...
func TestSelectAssetsWindowsCUDA(t *testing.T) {
	...
	assets := []releaseAsset{
		{Name: "sd-master-6b3edaa-bin-win-cuda12-x64.zip", DownloadURL: "https://example.com/stable-diffusion.zip"},
