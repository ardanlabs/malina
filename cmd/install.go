...
var InstallCmd = &cli.Command{
	...
	Flags: []cli.Flag{
		&cli.StringFlag{
			Name:    "version",
			Aliases: []string{"v"},
			Usage:   `version of stable-diffusion.cpp to install (e.g. "master-820-de298c2"; default is the malina-pinned version, pass "latest" to query the GitHub releases API)`,
			Value:   "",
		},
		&cli.StringFlag{
			Name:    "lib",
